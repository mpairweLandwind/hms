...
public class MedicalRecordRepositoryImpl extends GenericRepositoryImpl<MedicalRecord, Long>
    ...
    public List<MedicalRecord> findByPatient(Patient patient) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<MedicalRecord> query = session.createQuery(
                    "FROM MedicalRecord mr WHERE mr.patient = :patient AND mr.isDeleted = false ORDER BY mr.visitDate DESC",
                    MedicalRecord.class);
    ...
    public List<MedicalRecord> findByDoctor(Doctor doctor) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<MedicalRecord> query = session.createQuery(
                    "FROM MedicalRecord mr WHERE mr.doctor = :doctor AND mr.isDeleted = false ORDER BY mr.visitDate DESC",
                    MedicalRecord.class);
    ...
    public List<MedicalRecord> findByAppointment(Appointment appointment) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<MedicalRecord> query = session.createQuery(
                    "FROM MedicalRecord mr WHERE mr.appointment = :appointment AND mr.isDeleted = false",
                    MedicalRecord.class);
    ...
    public List<MedicalRecord> findByStatus(String status) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<MedicalRecord> query = session.createQuery(
                    "FROM MedicalRecord mr WHERE mr.status = :status AND mr.isDeleted = false",
                    MedicalRecord.class);
    ...
    public List<MedicalRecord> findByDateRange(LocalDateTime startDate, LocalDateTime endDate) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<MedicalRecord> query = session.createQuery(
                    "FROM MedicalRecord mr WHERE mr.visitDate BETWEEN :startDate AND :endDate AND mr.isDeleted = false ORDER BY mr.visitDate DESC",
                    MedicalRecord.class);
    ...
    public List<MedicalRecord> findByDiagnosis(String diagnosis) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<MedicalRecord> query = session.createQuery(
                    "FROM MedicalRecord mr WHERE LOWER(mr.diagnosis) LIKE LOWER(:diagnosis) AND mr.isDeleted = false",
                    MedicalRecord.class);
    ...
    public List<MedicalRecord> findDeletedRecords() {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<MedicalRecord> query = session.createQuery(
                    "FROM MedicalRecord mr WHERE mr.isDeleted = true", MedicalRecord.class);
            return query.getResultList();
        } catch (Exception e) {
    ...
    public long countByStatus(String status) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<Long> query = session.createQuery(
                    "SELECT COUNT(*) FROM MedicalRecord mr WHERE mr.status = :status AND mr.isDeleted = false", Long.class);
            query.setParameter("status", status);
    ...
    public long countByPatient(Patient patient) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<Long> query = session.createQuery(
                    "SELECT COUNT(*) FROM MedicalRecord mr WHERE mr.patient = :patient AND mr.isDeleted = false", Long.class);
            query.setParameter("patient", patient);
            return query.getSingleResult();
        } catch (Exception e) {
    ...
    public List<MedicalRecord> findAll() {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<MedicalRecord> query = session.createQuery("FROM MedicalRecord mr WHERE mr.isDeleted = false ORDER BY mr.visitDate DESC", MedicalRecord.class);
            return query.getResultList();
        } catch (Exception e) {
