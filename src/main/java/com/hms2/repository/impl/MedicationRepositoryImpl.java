...
public class MedicationRepositoryImpl extends GenericRepositoryImpl<Medication, Long>
    ...
    public Optional<Medication> findByMedicationName(String medicationName) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<Medication> query = session.createQuery(
                    "FROM Medication m WHERE m.medicationName = :medicationName AND m.isDeleted = false",
                    Medication.class);
    ...
    public List<Medication> findByGenericName(String genericName) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<Medication> query = session.createQuery(
                    "FROM Medication m WHERE m.genericName = :genericName AND m.isDeleted = false",
                    Medication.class);
    ...
    public List<Medication> findByBrandName(String brandName) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<Medication> query = session.createQuery(
                    "FROM Medication m WHERE m.brandName = :brandName AND m.isDeleted = false",
                    Medication.class);
    ...
    public List<Medication> findByManufacturer(String manufacturer) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<Medication> query = session.createQuery(
                    "FROM Medication m WHERE m.manufacturer = :manufacturer AND m.isDeleted = false",
                    Medication.class);
    ...
    public List<Medication> findByStatus(String status) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<Medication> query = session.createQuery(
                    "FROM Medication m WHERE m.status = :status AND m.isDeleted = false",
                    Medication.class);
    ...
    public List<Medication> findAvailableMedications() {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<Medication> query = session.createQuery(
                    "FROM Medication m WHERE m.status = 'AVAILABLE' AND m.stockQuantity > 0 AND m.isDeleted = false",
                    Medication.class);
            return query.getResultList();
        } catch (Exception e) {
    ...
    public List<Medication> findLowStockMedications() {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<Medication> query = session.createQuery(
                    "FROM Medication m WHERE m.stockQuantity <= m.minimumStockLevel AND m.isDeleted = false",
                    Medication.class);
            return query.getResultList();
        } catch (Exception e) {
    ...
    public List<Medication> findDeletedMedications() {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<Medication> query = session.createQuery(
                    "FROM Medication m WHERE m.isDeleted = true", Medication.class);
            return query.getResultList();
        } catch (Exception e) {
        ...
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<Medication> query = session.createQuery(
                    "FROM Medication m WHERE (LOWER(m.medicationName) LIKE LOWER(:name) OR " +
                            "LOWER(m.genericName) LIKE LOWER(:name) OR LOWER(m.brandName) LIKE LOWER(:name)) AND m.isDeleted = false",
                    Medication.class);
    ...
    public long countByStatus(String status) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<Long> query = session.createQuery(
                    "SELECT COUNT(*) FROM Medication m WHERE m.status = :status AND m.isDeleted = false", Long.class);
            query.setParameter("status", status);
    ...
    public List<Medication> findAll() {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<Medication> query = session.createQuery("FROM Medication m WHERE m.isDeleted = false", Medication.class);
            return query.getResultList();
        } catch (Exception e) {
